...
make artifacts                      # tag = "dev"
make artifacts VERSION=v1.0.0       # tag = "v1.0.0"

# Run a feature's integration tests
devcontainer features test -f install-pixi --skip-autogenerated --project-folder .
