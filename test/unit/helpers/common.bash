...
reload_lib() {
  ...
  unset _LIB_OS_LOADED _LIB_SHELL_LOADED _LIB_OSPKG_LOADED \
    _LIB_NET_LOADED _LIB_GIT_LOADED _LIB_LOGGING_LOADED \
    _LIB_CHECKSUM_LOADED _LIB_GITHUB_LOADED _LIB_USERS_LOADED

  # Reset os.sh lazy-cached globals.
  unset _OS_KERNEL _OS_ARCH _OS_ID _OS_ID_LIKE _OS_PLATFORM _OS_RELEASE_LOADED
